...
public class BusinessUser {
   ...
   @Column(name = "id")
    ...
    //PER LE RELAZIONI BIDIREZIONALI per proteggre da chi non capisce l'owner 
    //(metodo per la sincronizzazione) si ha piu protezione perche entrambi i lati sono sincronizzati
    //Serve solo per il lato non owner
